...
| 8 | Scale-out | Contexts: bounded portable datasets that agents discover, attach, and query together; federation over composition, not transparent shards | Proposal only (2026-08-23), see [contexts.md](contexts.md); nothing implemented |
