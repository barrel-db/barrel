...
### Changed
- Requires `barrel ~> 1.3`, `barrel_spaces ~> 1.2` and `barrel_ngram ~> 0.10`. The old `barrel ~> 1.0` floor still resolved barrel 1.0 with barrel_vectordb 2.1 and its `gen_batch_server` dependency.
