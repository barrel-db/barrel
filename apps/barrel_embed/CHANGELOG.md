...
- `barrel_embed_request_tests`: mocks hackney to assert that the OpenAI and
  Cohere adapters build the right URL, auth header, and JSON body, and parse
  responses back in index order, without hitting the network
- CI now runs these backend-free request-building tests as part of the
  umbrella job (venv- and Ollama-dependent tests stay excluded)
- `rebar3_hex` added to the plugin list so the app can be published
  standalone to Hex

### Changed

- hackney pinned to 4.4.5 to match `barrel_vectordb` in the umbrella build
- `cover_enabled` turned on for parity with the other umbrella apps
- Package links point at the umbrella repository
  (`https://github.com/barrel-db/barrel`) instead of a per-app repo
- Documentation migrated from MkDocs to ExDoc; see the guides linked from
  this package's HexDocs page
...
[2.3.0]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v2.3.0
[2.2.1]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v2.2.1
[2.2.0]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v2.2.0
[2.1.1]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v2.1.1
[2.0.1]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v2.0.1
[2.0.0]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v2.0.0
[1.0.0]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v1.0.0
[0.2.0]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v0.2.0
[0.1.0]: https://github.com/barrel-db/barrel/releases/tag/barrel_embed-v0.1.0
